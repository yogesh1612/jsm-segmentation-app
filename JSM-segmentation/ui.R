    ...
    sidebarLayout(
        sidebarPanel(
            ...
            conditionalPanel(condition="input.tabselected==3",
                             ...
                             textInput('bname',label = "Enter Brand Name (seperated by comma)"),
                             textInput('aname',label = "Enter Attribute Name (seperated by comma)"),
        ...
        mainPanel(
            tabsetPanel(type='tabs',
                        ...
                        tabPanel("JSM Plot",value = 3,
                                # htmlOutput("seg"),
                                htmlOutput('segselect'),
                                 plotOutput("plot", height = 800, width = 840))
